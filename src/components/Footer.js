      ...
      <footer class="text-white bg-black lg:grid lg:grid-cols-5">
        <aside class="hidden lg:relative lg:col-span-2 lg:block">
          <img
            ...
            src="https://astrostorebucket.s3.eu-west-3.amazonaws.com/brighttech/tech/simon-lee-M-6QQXJ8AG4-unsplash.jpg"
            alt="Comic Graphic"
          />
        </aside>
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p class="font-medium">
                ...
                <p class="block text-2xl sm:text-3xl hover:opacity-75">
                  +225 0789738186
                </p>
              </p>

              <ul class="mt-8 space-y-2 text-sm">
                <li>Du lundi au vendredi : 9 h - 17 h</li>
                <li>Week-end : 9 h - 15 h</li>
              </ul>
          ...
          <div class="pt-12 mt-12 border-t border-gray-800">
            <div class="text-sm text-gray-300 sm:items-center sm:justify-between sm:flex">
              ...
              <p class="mt-4 sm:mt-0">
                © 2022 Bright Tech. Tous droits réservés.
              </p>
            </div>

            <p class="mt-8 text-xs text-gray-500">
              Les expériences numériques évoluent constamment et les clients
              sont de plus en plus exigeants. Que faites-vous pour vous assurer
              que le vôtre suit le rythme ? Bright Tech vous aide à créer les
              meilleures expériences possibles pour les utilisateurs.
            </p>
          </div>
        </div>
      </footer>
